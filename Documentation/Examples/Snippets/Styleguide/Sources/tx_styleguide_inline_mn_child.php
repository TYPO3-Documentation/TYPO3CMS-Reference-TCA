<?php // Example from extension "styleguide", table "tx_styleguide_inline_mn"

return [
   // [start ctrl]
   'ctrl' => [ 
      'title' => 'Form engine - inline mn child',
      'label' => 'input_1',
      'tstamp' => 'tstamp',
      'crdate' => 'crdate',
      'cruser_id' => 'cruser_id',
   ...
   'columns' => [ 
      ...
      // Example from extension "styleguide", table "tx_styleguide_inline_mn_child"
